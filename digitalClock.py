...
#width,height, x-axis, y-axis. We have kept 0 bcos we will start from left top corner.
...
lb_mn=Label(clk,text='60', font=("Times 20 bold",75,'bold'), bg="#008EA4", fg='white')
...
lb_sc=Label(clk,text='60', font=("Times 20 bold",75,'bold'), bg="#06B4B8", fg='white')
